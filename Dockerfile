...
RUN \
  ...
  sed -i 's#do_git_checkout https://chromium.googlesource.com/webm/libvpx.git#do_git_checkout https://chromium.googlesource.com/webm/libvpx.git libvpx_git "origin/main"#' /ffmpeg-windows-build-helpers/cross_compile_ffmpeg.sh && \
